# Production Plan — Power BI custom visual

A Power BI custom visual for production planning: capacity vs. load, MRP-style
pull replenishment, and weekly area scheduling. Part of the **Production Visual**
suite (https://productionvisual.com).
